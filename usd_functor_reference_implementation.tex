...
\textbf{D0-step.}  Begin with broad sociological and economic USD records
...
\textbf{C-step.}  The social and economic records are read together only
...
\textbf{D1-step.}  Now restrict the compressed record to the local Satoshi
context.  Let
\[
  \rho_{\mathrm{Sat}}:
...
\textbf{E-step.}  Anchor the local record between an initial founder-action
...
\textbf{S-step.}  The sideways stabilization is the core of the Satoshi
...
\textbf{T-step.}  Let $\mathcal H_{\mathrm{Sat}}$ be the finite subdivided
...
\textbf{U-step.}  Finally, when the relevant lifted Kan extension exists,
